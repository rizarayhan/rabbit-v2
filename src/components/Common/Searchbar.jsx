      ...
      {isOpen ? (
        ...
        >
          <div className="relative w-1/2">
            ...
            <button
              type="submit"
              className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-600 hover:text-gray800 cursor-pointer"
            >
        ...
        <button onClick={handleToggleSearch} className="cursor-pointer">
